    ...
    <Container fluid className="flex-grow-1 pe-3 teste  w-100 asd">
      ...
      <Card style={{ width: "18rem" }}>
        <Card.Img
          className="tamnahoImg"
          variant="top"
          src="https://70096.cdn.simplo7.net/static/70096/sku/delicias-mineiras-mel-goumet-florada-cipo-uva-500g-nectar-da-canastra--p-1661614805982.png"
        />
        <Card.Body>
...
function Cardizinho2(){
  const ListaProdutos =  [
    ...
    var cardizino = ListaProdutos.map((value)=>{
